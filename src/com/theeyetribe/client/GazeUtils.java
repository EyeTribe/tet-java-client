...
public class GazeUtils {
	 ...
	 */
	public static Point2D getEyesCenterPixels(Eye leftEye, Eye rightEye,
	 ...
	 * @return the average center point in pixels
	 */
	public static Point2D getEyesCenterPixels(GazeData gazeData,
			int screenWidth, int screenHeight) {
		if (null != gazeData)
			return getEyesCenterPixels(gazeData.leftEye, gazeData.rightEye,
	...
	/**
	 * Calculates distance between pupil centers based on previously recorded
	 * min and max values.
	 * 
	 * @param leftEye
	 * @param rightEye
	...
	public static double getEyesDistanceNormalized(Eye leftEye, Eye rightEye) {
		if (null != leftEye && null != rightEye) {
			double dist = Math.abs(getDistancePoint2D(
	 ...
	 * @return
	 */
	public static Point2D getRelativeToScreenSpace(Point2D point,
			int screenWidth, int screenHeight) {
	 ...
	 * @return
	 */
	public static Point2D getNormalizedCoords(Point2D point, int screenWidth,
			int screenHeight) {
		Point2D norm = null;
	...
	/**
	 * Maps eye position of gaze coords within normalize space [x: -1:1 , y:
	 * -1:1]
	 * 
	 * @param point
	 * @param screenWidth
	 ...
	 * @return
	 */
	public static Point2D getNormalizedMapping(Point2D point, int screenWidth,
			int screenHeight) {
